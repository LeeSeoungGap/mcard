document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('data', () => ({
        ...
        //세로 배너 텍스트
        vtext: `지금까지 곁에서 저희를 아껴주셨던 감사한 분들을 모시고 혼인의 예를 갖추는 것이 도리인 줄 아오나 양가 부모님과 친지분들만 참석하여 작은 결혼식을 올리게 되었습니다. 넓은 마음으로 양해 부탁드리며 멀리서나마 저희 두 사람 축복해 주시는 귀한 마음을 소중히 간직하겠습니다.`,
        //달력 요일, 시간
